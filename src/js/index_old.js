...
import { GameManager } from "./Managers/managers";

GameManager.init({
    pickup_deck_el: document.getElementById("deck"),
    discard_deck_el: document.getElementById("second_deck"),
});
...
function createPlayers() {
    gameMgr.registerPlayers([
        new player("You", document.getElementById("player_one"), "face_up", true),
        new player("Computer Left", document.getElementById("player_two"), "face_down", false),
        new player("Computer Top", document.getElementById("player_three"), "face_down", false),
        new player("Computer Right", document.getElementById("player_four"), "face_down", false)
    ]);
